...
1.先问了问项目，又问了下相关的react-three-fiber
...
5.px转rem有没有什么好的方法（vscode里直接转的，不知道）

6.grid布局和flex布局用法，有什么本质上的区别
...
详见：[https://hackmd.io/@2qVnJRlJRHCk20dvVxsySA/H1xLHUQ8e?type=view#side-by-side-**comparison**](https://hackmd.io/@2qVnJRlJRHCk20dvVxsySA/H1xLHUQ8e?type=view#side-by-side-**comparison**)
